...
Copyright (c) 2013, {currentYear} Oracle and/or its affiliates. All rights reserved.
...
this specification when interacting with threads.
...
public class CtxListener implements ServletContextListener {
  ...
  public void contextInitialized(ServletContextEvent scEvent) {
    ...
    loggerHandle = mes.scheduleAtFixedRate(logger,
                                           5,  // initial delay
                                           60, // period
                                           TimeUnit.SECONDS);
  }
